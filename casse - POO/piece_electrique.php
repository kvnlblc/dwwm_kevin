        ...
        <body>
            <div class="container mt-5 mb-3">
                ...
                <div class="border border-dark w-25 bg-white">
                    ...
                    <div class="container mt-5 mb-3">
                        <h2>Sélectionnez la pièce recherchée :</h2>
                        <select class="form-select border-dark" aria-label="Type de véhicule">
                            <option selected disabled>Choisissez une pièce</option>
...
$pieceElectrique = new PieceElectrique();
$pieceElectrique->afficherPage();
?>
